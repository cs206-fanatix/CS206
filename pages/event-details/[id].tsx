                        ...
                        {({ open }) => (
                            <>
                                ...
                                <Disclosure.Panel className="px-4 pt-3 pb-2 text-sm -mt-3 bg-secondary rounded-b-lg">
                                    <h1 className='text-accent text-lg py-2 pl-1 font-bold'>STANDARD</h1>
                                    <p className='text-white text-base p-1'>CAT 1 (STANDING): S$118</p>
                                    <p className='text-white text-base p-1'>CAT 2 (STANDING): S$108</p>
