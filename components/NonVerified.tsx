    ...
    return (
        <div className='flex flex-col bg-primary h-60 w-120 py-2 px-3
            ...
            <div className='p-6 text-center'>
                ...
                <h3 className='mb-5 text-lg font-normal text-accent '>You have to be verified to get early access.</h3>
                
                <Link href={props.kycLink}>
                    <a className="text-semibold text-white bg-red-600 hover:bg-red-800 hover:text-white focus:ring-4 focus:outline-none focus:ring-red-300  rounded-lg border text-sm font-medium px-5 py-2.5 text-md mr-2">Verify now</a>
                </Link>
